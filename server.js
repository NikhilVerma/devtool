...
electron.protocol.registerSchemesAsPrivileged([
    { scheme: 'file', privileges: { standard: true, secure: true, bypassCSP: true } },
]);
...
if (argv.config && argv.config.v8) {
    var flags = [].concat(argv.config.v8.flags).filter(Boolean);
...
app.on('ready', function () {
    ...
    electron.protocol.interceptBufferProtocol(
        'file',
